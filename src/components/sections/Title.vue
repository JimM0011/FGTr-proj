...
// 标题
const title = 'Masking Cascaded Self-Attentions for Few-Shot Font-Generation Transformer'
...
const buttons = [
  {
    disabled: false,
    name: "Paper",
    link: "https://openaccess.thecvf.com/content/ACCV2024/html/Ma_Masking_Cascaded_Self-Attentions_for_Few-Shot_Font-Generation_Transformer_ACCV_2024_paper.html",
    component: Document,
  },
  {
    disabled: true,
